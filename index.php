  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8 mt-4">
        <form class="nom" action="index.php" method="post">
          <div class="form-group">
            <label class="col-sm-3 col-form-label" name="civilite">Civilité: </label>
            <select name="civilite">
              <option value="monsieur" select="selected">Monsieur </option>
              <option value="madama">Madame </option>
            </select>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-sm-3 col-form-label">Société: </label>
            <input type="text" name="societe" placeholder="Societe" value="<?php if (isset($_POST['societe'])){echo $_POST['societe'];} ?>">
          </div>
          <div>
            <button type="submit" name="button" value="envoyer">Submit</button>
          </div>
        </div>
      </div>
      <div class="row1">
        <div class="col-sm-8 mt-4">
          <p>Bonjour <?php echo $_POST['civilite'] . ' ' . $_POST['nom'] . ' ' . $_POST['prenom'] . ' ' .  $_POST['age'] . ' ' . $_POST['societe']; ?></p>
        </div>
      </div>
